...
const client = new Client({
  phoneNumber: '201038436911', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
  ...
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "201038436911@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "201038436911@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "201038436911@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
